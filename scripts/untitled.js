// Untitled UI Interactive Components Script
...
function initTabs() {
    const tabButtons = document.querySelectorAll('.untitled-tab[data-tab]');
    const tabPanels = document.querySelectorAll('.tab-panel[data-panel]');

    tabButtons.forEach(button => {
        button.addEventListener('click', function() {
            const targetTab = this.getAttribute('data-tab');
            const tabContainer = this.closest('.untitled-card');
            
            // Remove active class from all tabs in this container
            tabContainer.querySelectorAll('.untitled-tab').forEach(tab => {
                tab.classList.remove('untitled-tab-active');
            });
            
            // Add active class to clicked tab
            this.classList.add('untitled-tab-active');
...
function initAccordion() {
    const accordionHeaders = document.querySelectorAll('.untitled-accordion-header');

    accordionHeaders.forEach(header => {
        header.addEventListener('click', function() {
            const accordionItem = this.closest('.untitled-accordion-item');
            const content = accordionItem.querySelector('.untitled-accordion-content');
            const icon = this.querySelector('.untitled-accordion-icon');
            const isActive = accordionItem.classList.contains('active');

            // Close all accordion items in the same accordion
            const accordion = accordionItem.closest('.untitled-accordion');
            accordion.querySelectorAll('.untitled-accordion-item').forEach(item => {
                if (item !== accordionItem) {
                    item.classList.remove('active');
                    const itemContent = item.querySelector('.untitled-accordion-content');
                    const itemIcon = item.querySelector('.untitled-accordion-icon');
                    if (itemContent) {
    ...
    document.querySelectorAll('.untitled-accordion-item').forEach(item => {
        const content = item.querySelector('.untitled-accordion-content');
        const icon = item.querySelector('.untitled-accordion-icon');
...
function initSwitches() {
    const switches = document.querySelectorAll('.untitled-switch');

    switches.forEach(switchEl => {
        switchEl.addEventListener('change', function() {
            // You can add custom logic here based on switch state
            const label = this.closest('.untitled-switch-label');
...
function initButtons() {
    ...
    pricingButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const planName = card.querySelector('.untitled-h3').textContent;
    ...
    const componentButtons = document.querySelectorAll('.untitled-buttons-demo button');
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function(e) {
            ...
            if (href !== '#' && href !== '') {
                ...
                if (target) {
                    const navHeight = document.querySelector('.untitled-nav').offsetHeight;
...
function initTableInteractivity() {
    const tableRows = document.querySelectorAll('.untitled-table tbody tr');
...
function initBadges() {
    const badges = document.querySelectorAll('.untitled-badge');
...
style.textContent = `
    ...
    .untitled-table tbody tr.selected {
